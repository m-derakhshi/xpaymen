...
readonly class CryptoTransactionDTO
{
    public function __construct(
        ...
        public ?float $blockchainExpectedPaymentAmount,
        public ?float $blockchainPaymentAmount,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            blockchainExpectedPaymentAmount: (float) $data['blockchain_expected_payment_amount'],
            blockchainPaymentAmount: (float) $data['blockchain_payment_amount'],
            blockchainUnpaidAmount: (string) $data['blockchain_unpaid_amount'],
